...
@section('main')
  <div id="page-wrapper">
      <div class="container-fluid">
          <div class="row">
              <div class="col-lg-12">
                  <h3 class="page-header">Data Pengajuan Warga</h3>
              </div>
              <!-- /.col-lg-12 -->
          </div>
              ...
              <div class="col-lg-12">
                  <div class="panel panel-primary">
                      <div class="panel-heading">
                          <i class="fa fa-bar-chart-o fa-fw"></i> Data Pengajuan Warga
                                ...
                                @foreach($warga as $w)
                                  <tr class="odd gradeX">
                                      ...
                                      <td class="text-center">
                                        <a href="{{url('hapus-pengajuan-warga')}}/{{$w->id}}" class="btn btn-danger btn-sm">Hapus</a>
                                      </td>
                                  </tr>
                                  @endforeach
                              </tbody>
